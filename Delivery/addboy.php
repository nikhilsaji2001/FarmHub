...
<body>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
									 ...
									 include'includes/dbconnect.php';
									  $sql=mysql_query("SELECT * FROM dreg NATURAL JOIN login WHERE dreg.dmailid=login.username AND login.status='1'",$con);
	...
	if(isset($_POST['register']))
   {
	...
	$dboy=$_POST['dboy'];
	      ...
	      $id=$_GET['id'];
            $sql="UPDATE ordermain SET did='$dboy' where orderid='$id'";
            if(mysql_query($sql,$con))
            {
                
                    echo"<script>alert('Added ');</script>";
                    echo"<script>location.href='vorder.php';</script>";
