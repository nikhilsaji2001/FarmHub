    ...
    <div class="contact-box-main">
        <div class="container">
            ...
            <tr id="header">
			  ...
			  $sq=mysql_query("select did from dreg where dmailid='$uname'",$con);
              ...
              $result = mysql_query("SELECT * FROM ordermain WHERE did='$id' AND pstatus='0'",$con);
			  ...
			  <?php
				  if($row['pstatus']==0)
				  {
					  echo "<td><a href='update.php?id=$row[orderid]' id='approve'>Delivered</a></td>";
				  }
